...
?>
	...
	<div class='col-sm-6 col-xs-6'>
		<input type="text" name="directiveTimer" id="user" class="form-control createUser" placeholder="Current: <?php 					$con = mysqli_connect("localhost", "d5g9x9d8_user","1qwerty1","d5g9x9d8_test2AndrewForLife") or die(mysql_error());
