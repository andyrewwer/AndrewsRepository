...
while($row = $result->fetch_assoc()) {   
    ...
    $queryUpdate = "INSERT INTO  `d5g9x9d8_testDB`.`Responses` (
    `Recipient`,
    `RecipientName`,
    `Directive`,
    `DirectiveNumber`,
...
// $queryNews = "INSERT INTO  `d5g9x9d8_testDB`.`News` (
// `NewsNumber`, 
// `NewsTitle`, 
// `NewsDescription`, 
...
// $queryUpdateNavBar = "UPDATE `d5g9x9d8_testDB`.`NavBar` SET `Privacy` = 1 WHERE `ID` = 15";
