	...
	$users = 0;
		...
		if (endsWith($_POST['bgImage'], '.png') || endsWith($_POST['bgImage'], '.jpg')){
			...
			while ($row = $userResult->fetch_assoc()){
				...
				$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$row['VariableValue']."' WHERE `GlobalVariables`.`VariableName` = 'backgroundImageBackup';";
			 	$result = mysqli_query($con, $query);
		 			die(mysqli_error($con));
		...
		$query =  "UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newCurrent. "' WHERE `GlobalVariables`.`VariableName` = 'backgroundImage';";
		$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newBackup."' WHERE `GlobalVariables`.`VariableName` = 'backgroundImageBackup';";
	 	$result = mysqli_query($con, $query);
	 	$result2 = mysqli_query($con, $query2);
	 	if ($result) {
		...
		if ($result->num_rows > 0) {
			...
			$query =  "UPDATE  `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET  `VariableValue` =  'Y' WHERE  `GlobalVariables`.`VariableName` = 'CrisisHasStarted' LIMIT 1 ;";
	 		$result = mysqli_query($con, $query); 
		 	if ($result) {
		...
		while ($row = $userResult->fetch_assoc()){
			...
			$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$row['VariableValue']."' WHERE `GlobalVariables`.`VariableName` = 'GoogleDocBackup';";
		 	$result = mysqli_query($con, $query);
		 	$result2 = mysqli_query($con, $query2);
		 	if ($result2) {
		...
		$query =  "UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newCurrent. "' WHERE `GlobalVariables`.`VariableName` = 'GoogleDoc';";
		$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newBackup."' WHERE `GlobalVariables`.`VariableName` = 'GoogleDocBackup';";
	 	$result = mysqli_query($con, $query);
	 	$result2 = mysqli_query($con, $query2);
	 	if ($result) {
			header("Location: settings.php?message=revert");
		...
		if (endsWith($_POST['favicon'], '.png') || endsWith($_POST['favicon'], '.jpg')){
			...
			while ($row = $userResult->fetch_assoc()){
				...
				$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$row['VariableValue']."' WHERE `GlobalVariables`.`VariableName` = 'faviconBackup';";
			 	$result = mysqli_query($con, $query);
			 	$result2 = mysqli_query($con, $query2);
			 	if ($result2) {
		...
		$query =  "UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newCurrent. "' WHERE `GlobalVariables`.`VariableName` = 'favicon';";
		$query2 = " UPDATE `d5g9x9d8_{{CONFERENCE_NAME}}`.`GlobalVariables` SET `VariableValue` = '".$newBackup."' WHERE `GlobalVariables`.`VariableName` = 'faviconBackup';";
	 	$result = mysqli_query($con, $query);
	 	$result2 = mysqli_query($con, $query2);
	 	if ($result) {
			header("Location: settings.php?message=revert");
...
MUNCrisis Webmaster';
		...
		$query =  "UPDATE  `d5g9x9d8_{{CONFERENCE_NAME}}`.`Users` SET  `pass` =  '".$password."' WHERE  `Users`.`id` = ".$id." LIMIT 1 ;";
