...
while($row = $GlobalVarresult->fetch_assoc()) {
	...
	?>
						...
						<div class="form-group">
							...
							<div style="padding-left: 30px">
								<input type="radio" name="Sender" value="Individual - Intelligence Officer" onclick='hideThem()'>      Individual (Intelligence Officer) <br> </input>
								<input type="radio" name="Sender" value="Individual - Senior Executive" onclick='hideThem()'>      Individual (Senior Executive) <br> </input>
								...
								<?php $con = mysqli_connect("localhost", "dbilh9sp_user","1qwerty1","dbilh9sp_{{CONFERENCE_NAME}}") or die(mysql_error());
	...
	while($row = $result->fetch_assoc()) {
		...
		$i ++;
 		...
 		<br>
							<label class=" control-label" for="requestSender">Request Type:</label> <br>
                        <div style="padding-left: 30px">
								<input type="radio" name="Type" value="Active Measures"> Active Measures<br>
								<input type="radio" name="Type" value="Agent Meeting"> Agent Meeting<br>
								<input type="radio" name="Type" value="Communication"> Communication<br>
								<input type="radio" name="Type" value="Dead/Livedrop"> Dead/Livedrop<br>
								<input type="radio" name="Type" value="Intelligence Analysis"> Intelligence Analysis<br>
								<input type="radio" name="Type" value="Interrogation"> Interrogation<br>
								<input type="radio" name="Type" value="Press"> Press<br>
								<input type="radio" name="Type" value="Recruitment"> Recruitment<br>
								<input type="radio" name="Type" value="Research & Development"> Research & Development<br>
								<input type="radio" name="Type" value="Surveillance"> Surveillance<br>
<br>
							</br>
							</div>
							<br>
